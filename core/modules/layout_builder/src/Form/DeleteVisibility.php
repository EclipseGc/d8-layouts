...
class DeleteVisibility extends ConfirmFormBase {
  ...
  public function ajaxCancel(array &$form, FormStateInterface $form_state) {
    $parameters = $form_state->getValue('parameters');
    $new_form = \Drupal::formBuilder()->getForm('\Drupal\layout_builder\Form\BlockVisibility', $parameters['entity_type'], $parameters['entity'], $parameters['field_name'], $parameters['delta'], $parameters['region'], $parameters['uuid']);
